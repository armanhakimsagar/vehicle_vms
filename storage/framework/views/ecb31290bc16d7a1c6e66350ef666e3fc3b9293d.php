...
function main_type_datalist () {
    var table = $('#main_type_list_table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "<?php echo e(url('dashboard/mainTypeList')); ?>",
            data: function (d) {
...
<?php echo $__env->make('layouts.enduser.dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/enduser/dashboard/maintenance_type.blade.php ENDPATH**/ ?>