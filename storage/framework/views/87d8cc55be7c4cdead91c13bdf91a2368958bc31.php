    ...
    <div class="kt-aside__brand kt-grid__item " id="kt_aside_brand">
        <div class="kt-aside__brand-logo">
            <a href="<?php echo e(url('dashboard/d/dashboard')); ?>">
                ...
                <?php else: ?>
                <img alt="Logo" src="<?php echo e(asset('public/assets/media/logos/crm-logo-2.png')); ?>" />
                <?php endif; ?>
            </a>
        </div>
                ...
                <li class="kt-menu__item  kt-menu__item--submenu" id="vehicle_part" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                    ...
                    <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                        <ul class="kt-menu__subnav">
                            ...
                            <li class="kt-menu__item " aria-haspopup="true">
                                <a href="<?php echo e(url('vehicle-type')); ?>" class="kt-menu__link  vms_menu_item" id="vehicle_group" data-rel="vehicle_group">
                                    <i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>
                ...
                <li class="kt-menu__item kt-menu__item--submenu" id="vendor" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                    ...
                    <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                        <ul class="kt-menu__subnav">
                            ...
                            <li class="kt-menu__item " aria-haspopup="true">
                                <a href="<?php echo e(url('v-type-index')); ?>" class="kt-menu__link  vms_menu_item" id="vendor_manage" data-rel="vendor_manage">
                                    <i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>
                ...
                <li class="kt-menu__item kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                    ...
                    <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                        <ul class="kt-menu__subnav">
                            ...
                            <li class="kt-menu__item " aria-haspopup="true">
                                <a href="<?php echo e(url('customer-group-index')); ?>" class="kt-menu__link  vms_menu_item" id="customer" data-rel="customer">
                                    <i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>
                ...
                <li class="kt-menu__item kt-menu__item--submenu" id="settings" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                    ...
                    <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                        <ul class="kt-menu__subnav">
                            ...
                            <li class="kt-menu__item " aria-haspopup="true">
                                <a href="<?php echo e(route('sms_log_index')); ?>" class="kt-menu__link  vms_menu_item" id="localization" data-rel="localization">
                                    <span class="kt-menu__link-icon">
                                        <i class="fas fa-car"></i>
                                    </span>
                                    <span class="kt-menu__link-text">Sms Log</span>
                                </a>
                            </li>
...
</div><?php /**PATH /var/www/html/resources/views/layouts/enduser/dashboard/sideber.blade.php ENDPATH**/ ?>