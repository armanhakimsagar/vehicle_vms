...
<form action="" id="editUsersForm" method="post">
    ...
    <?php echo e(method_field('PUT')); ?>
        ...
        <div class=" row form-group">
            <label for="name" class="col-lg-3 col-form-label">Customer group </label>
            <div class="col-lg-9">
...
<script>
    ...
    $('form#editUsersForm').submit(function(event) {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo e(url('customer-group-update', '')); ?>/"+id,
...
</script><?php /**PATH /var/www/html/resources/views/enduser/customer_group/edit.blade.php ENDPATH**/ ?>