                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card custom-card"
                            style="background-image: url('<?php echo e(asset("public/assets/media/misc/bg-1.jpg")); ?>')">
                    ...
                    <div class="col-md-4">
                        <div class="card custom-card"
                            style="background-image: url('<?php echo e(asset("public/assets/media/bg/b.png")); ?>')">
                            <div class="card-body custom-card-body">
                    ...
                    <div class="col-md-4">
                        <div class="card custom-card"
                            style="background-image: url('<?php echo e(asset("public/assets/media/bg/bg-7.jpg")); ?>')">
                            <div class="card-body custom-card-body">
...
<?php echo $__env->make('layouts.enduser.dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/enduser/dashboard/vehicle.blade.php ENDPATH**/ ?>