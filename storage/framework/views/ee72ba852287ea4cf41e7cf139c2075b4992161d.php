        ...
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <a href="" class="kt-subheader__breadcrumbs-link">Customer Group</a>
                </div>
            </div>
...
<script>
    ...
    $(function () {      
        ...
        var table= $('#user_table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "<?php echo e(url('customer-group-index')); ?>",
                data: function (d) {
    ...
    $(function () {
        ...
        $('.add_user').click(function (e) {
            ...
            $.ajax({
                url: "<?php echo e(url('customer-group-create')); ?>",
                type: "GET",
    ...
    function edit_data(id){
        $.ajax({
            url: "<?php echo e(url('/customer-group/edit/')); ?>"+"/"+id,
            type: "GET",
...
<?php echo $__env->make('layouts.enduser.dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/enduser/customer_group/index.blade.php ENDPATH**/ ?>