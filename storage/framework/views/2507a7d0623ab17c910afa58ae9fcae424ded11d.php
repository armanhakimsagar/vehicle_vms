                            ...
                            <div class="kt-widget kt-widget--user-profile-1">
                                <div class="kt-widget__head">
                                    <div class="kt-widget__media">
                                        <?php if($vehicle_staff->staff_image): ?>
                                        <img src="<?php echo e(asset('public/uploads/driver/'.$vehicle_staff->staff_image)); ?>"
                                            alt="image">
                                        <?php else: ?>
                                    ...
                                    <div class="kt-widget__content">
                                        <div class="kt-widget__section">
                                            <a href="" class="kt-widget__username"><?php echo e($vehicle_staff->staff_name); ?>

                                            </a>
                                        </div>
                                        <div class="kt-widget__action">
                                            <?php if($vehicle_staff->status==0): ?>
                                            <span class="btn btn-warning btn-sm">Inactive</span>
                                            <?php elseif($vehicle_staff->status==1): ?>
                                ...
                                <div class="kt-widget__body">
                                    <div class="kt-widget__content">
                                        <div class="kt-widget__info">
                                            ...
                                            <span class="kt-widget__data"> <?php echo e($vehicle_staff->staff_id); ?></span>
                                        </div>

                                        <div class="kt-widget__info">
                                            <span class="kt-widget__label">Phone </span>
                                            <span class="kt-widget__data"> <?php echo e($vehicle_staff->phone); ?></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 custom-form-group-border">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <span> <?php echo e($vehicle_staff->staff_id); ?></span>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-label col-sm-4">Staff Name </label>
                                                <div class="col-sm-8">
                                                    <span> <?php echo e($vehicle_staff->staff_name); ?></span>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-label col-sm-4">Father Name </label>
                                                <div class="col-sm-8">
                                                    <span> <?php echo e($vehicle_staff->father_name); ?></span>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <span> <?php echo e($vehicle_staff->mother_name); ?> </span>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-label col-sm-4">Date of Birth </label>
                                                <div class="col-sm-8">
                                                    <span> <?php echo e($vehicle_staff->date_of_birth); ?></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <span> <?php echo e($vehicle_staff->phone); ?></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <span> <?php echo e($vehicle_staff->email); ?></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <span> <?php echo e($vehicle_staff->contact_one); ?></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <span> <?php echo e($vehicle_staff->contact_two); ?></span>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-label col-sm-4">NID No</label>
                                                <div class="col-sm-8">
                                                    <span> <?php echo e($vehicle_staff->nid_no); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 custom-form-group-border">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <span> <?php echo e($vehicle_staff->permanent_address); ?></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <?php if($vehicle_staff->staff_type==1): ?>
                                                    <span>Supervisor</span>
                                                    <?php elseif($vehicle_staff->staff_type==2): ?>
                                                    <span>Driver</span>
                                                    <?php elseif($vehicle_staff->staff_type==3): ?>
                                                    <span >Contractor</span>
                                                    <?php elseif($vehicle_staff->staff_type==4): ?>
                                                    <span>Helper</span>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                            <?php if($vehicle_staff->staff_type==2): ?>
                                            <div class="form-group row">
                                                <label class="col-label col-sm-4">Driving Licence</label>
                                                <div class="col-sm-8">
                                                    <span> <?php echo e($vehicle_staff->driving_licence); ?></span>
                                                </div>
                                            </div>
                                            <?php endif; ?>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <span> <?php echo e($vehicle_staff->work_experience); ?></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <span> <?php echo e($vehicle_staff->previous_organisation); ?></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <?php if($vehicle_staff->assigned_vehicle): ?>
                                                    <span> <?php echo e($vehicle_staff->vehicle_no); ?> - <span
                                                            class="ml-2 mr-2 badge badge-pill badge-<?php echo e(($vehicle_staff->v_status==1) ? "success": "danger"); ?>"><?php echo e(($vehicle_staff->v_status==1) ? "Active": "Inactive"); ?></span></span>
                                                    <?php else: ?>
                                                    <span> NA</span>
                                                    <?php endif; ?>
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <span> <?php echo e($vehicle_staff->assigned_date); ?></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <?php if($vehicle_staff->status==1): ?>
                                                    <span class="badge badge-pill badge-success ml-3">Active</span>
                                                    <?php elseif($vehicle_staff->status==0): ?>
                            ...
                            <div class="kt-portlet__body">
                                <div class="kt-section kt-section--first">
                                    <div class="kt-section__body text-dark px-3">
                                        <div class="form-group row">
                                            <input type="hidden" id="id" value="<?php echo e($vehicle_staff->id); ?>">
                                            <label for="name" class="col-md-3 col-form-label">Staff ID <span
                                                    class="text-danger">*</span> </label>
                                            <div class="col-md-7">
                                                <input type="text" class="form-control"
                                                    value="<?php echo e($vehicle_staff->staff_id); ?>" name="staff_id">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                <input type="text" class="form-control"
                                                    value="<?php echo e($vehicle_staff->staff_name); ?>" name="staff_name">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                <input type="text" class="form-control"
                                                    value="<?php echo e($vehicle_staff->father_name); ?>" name="father_name">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                <input type="text" class="form-control"
                                                    value="<?php echo e($vehicle_staff->mother_name); ?>" name="mother_name">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                <input type="text" class="form-control"
                                                    value="<?php echo e($vehicle_staff->phone); ?>" name="phone">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                <input type="text" class="form-control"
                                                    value="<?php echo e($vehicle_staff->email); ?>" name="email">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                <input type="text" class="form-control"
                                                    value="<?php echo e($vehicle_staff->contact_one); ?>" name="contact_one">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                <input type="text" class="form-control"
                                                    value="<?php echo e($vehicle_staff->contact_two); ?>" name="contact_two">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="text" name="date_of_birth"
                                                        ...
                                                        value="<?php echo e($vehicle_staff->date_of_birth); ?>" />
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                <input type="text" class="form-control"
                                                    value="<?php echo e($vehicle_staff->nid_no); ?>" name="nid_no">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                <textarea class="form-control" name="present_address"
                                                    rows="2"><?php echo e($vehicle_staff->present_address); ?></textarea>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                <textarea class="form-control" name="permanent_address"
                                                    rows="2"><?php echo e($vehicle_staff->permanent_address); ?></textarea>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                <select name="staff_type" class="form-control kt-select2-2"
                                                    ...
                                                    <option value="1"
                                                        <?php echo e(($vehicle_staff->staff_type==1) ? 'selected': ''); ?>>
                                                        Supervisor</option>
                                                    <option value="2"
                                                        <?php echo e(($vehicle_staff->staff_type==2) ? 'selected': ''); ?>>
                                                        Driver</option>
                                                    <option value="3"
                                                        <?php echo e(($vehicle_staff->staff_type==3) ? 'selected': ''); ?>>
                                                        Contractor</option>
                                                    <option value="4"
                                                        <?php echo e(($vehicle_staff->staff_type==4) ? 'selected': ''); ?>>
                                                        Helper</option>
                                                </select>
                                        ...
                                        <div class="form-group row d-none" id="driving_licence_field">
                                            ...
                                            <div class="col-md-7">
                                                <input type="text" class="form-control"
                                                    value="<?php echo e($vehicle_staff->driving_licence); ?>" name="driving_licence">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                <input type="text" class="form-control"
                                                    value="<?php echo e($vehicle_staff->work_experience); ?>" name="work_experience">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                <input type="text" class="form-control"
                                                    value="<?php echo e($vehicle_staff->previous_organisation); ?>"
                                            ...
                                            <div class="col-md-7">
                                                <select name="assigned_vehicle" class="form-control kt-select2-2">
                                                    ...
                                                    <option value="<?php echo e($vehicle->id); ?>"
                                                        <?php echo e(($vehicle->id==$vehicle_staff->assigned_vehicle) ? 'selected': ''); ?>>
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group">
                                                    <input type="text" name="assigned_date"
                                                        value="<?php echo e($vehicle_staff->assigned_date); ?>"
                                                        class="form-control datepicker" />
                                                    <div class="input-group-append">
                                                        <div class="input-group-text"><i class="la la-calendar"></i>
                                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                <select name="status" class="form-control kt-select2-2">
                                                    <option value="1" <?php echo e(($vehicle_staff->status==1) ? 'selected': ''); ?>>
                                                        Active</option>
                                                    <option value="0" <?php echo e(($vehicle_staff->status==0) ? 'selected': ''); ?>>
                                                        Inactive</option>
                                                </select>
                                                ...
                                                <div class="kt-avatar kt-avatar--outline kt-avatar--circle"
                                                    ...
                                                    <div>
                                                        ...
                                                        <img class="kt-avatar__holder" id="img-crop"
                                                            src="<?php echo e(asset('public/uploads/driver/'.$vehicle_staff->staff_image)); ?>"
                                                            alt="">
                                                        <?php else: ?>
                                                        <img class="kt-avatar__holder" id="img-crop"
                                                            src="<?php echo e(asset('assets/media/users/default.jpg')); ?>"
                                                            alt="">
                                                        <?php endif; ?>
                                                    </div>
...
</script><?php /**PATH /var/www/html/resources/views/enduser/dashboard/vehicle_staff_view.blade.php ENDPATH**/ ?>