...
<form id="saveUserForm" method="post" action="<?php echo e(url('vehicle-type-store')); ?>">
...
<script>
 $(document).on('submit', 'form#saveUserForm', function(event) {
                       successMsg('Type created successfully.');
           });
</script><?php /**PATH /var/www/html/resources/views/enduser/vehicle_type/create.blade.php ENDPATH**/ ?>