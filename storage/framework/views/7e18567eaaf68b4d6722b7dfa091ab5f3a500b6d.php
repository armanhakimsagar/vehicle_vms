                            ...
                            <div class="row">
                                <div class="col-lg-6 custom-form-group-border">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span class="form-control"> <?php echo e($vendor->vendor_name); ?></span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-form-label col-md-4 col-sm-3">Company Name </label>
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span class="form-control"> <?php echo e($vendor->name); ?></span>
                                        </div>
                                    </div>
                                    <!-- <div class="form-group row">
                                        <label class="col-form-label col-md-4 col-sm-3">Father Name </label>
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span class="form-control"> <?php echo e($vendor->father_name); ?></span>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span class="form-control"> <?php echo e($vendor->mother_name); ?></span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span
                                                class="form-control"><?php echo e(date('d M yy', strtotime($vendor->date_of_birth))); ?></span>
                                        </div>
                                    </div> -->
                                    <!-- <div class="form-group row">
                                        <label class="col-form-label col-md-4 col-sm-3">Spouse Name </label>
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span class="form-control"> <?php echo e($vendor->spouse_name); ?></span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-form-label col-md-4 col-sm-3">Spouse Phone </label>
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span class="form-control"> <?php echo e($vendor->spouse_phone); ?></span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-form-label col-md-4 col-sm-3">Occupation </label>
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span class="form-control"> <?php echo e($vendor->occupation); ?></span>
                                        </div>
                                    </div> -->
                                    <div class="form-group row">
                                        <label class="col-form-label col-md-4 col-sm-3">NID No </label>
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span class="form-control"> <?php echo e($vendor->nid_no); ?></span>
                                        </div>
                                    </div>
                                    <!-- <div class="form-group row">
                                        <label class="col-form-label col-md-4 col-sm-3">Passport No </label>
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span class="form-control"> <?php echo e($vendor->passport_no); ?></span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <?php if($vendor->division): ?>
                                            <span class="form-control"> <?php echo e($vendor->divisions->name); ?></span>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <?php if($vendor->district): ?>
                                            <span class="form-control"> <?php echo e($vendor->districts->name); ?></span>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <?php if($vendor->thana): ?>
                                            <span class="form-control"> <?php echo e($vendor->thanas->name); ?></span>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span class="form-control"> <?php echo e($vendor->present_address); ?></span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-form-label col-md-4 col-sm-3">Permanent Address </label>
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span class="form-control"> <?php echo e($vendor->permanent_address); ?></span>
                                        </div>
                                    </div>
                                    <!-- <div class="form-group row">
                                        <label class="col-form-label col-md-4 col-sm-3">Billing Address </label>
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span class="form-control"> <?php echo e($vendor->billing_address); ?></span>
                                        </div>
                                    </div> -->
                                ...
                                <div class="col-lg-6 custom-form-group-border">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span class="form-control"> <?php echo e($vendor->vendor_due_limit); ?></span>
                                        </div>
                                    </div> -->
                                    <div class="form-group row">
                                        <label class="col-form-label col-md-4 col-sm-3">SMS Phone </label>
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span class="form-control"> <?php echo e($vendor->phone); ?></span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-form-label col-md-4 col-sm-3">Contact One </label>
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span class="form-control"> <?php echo e($vendor->contact_1); ?></span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-form-label col-md-4 col-sm-3">Contact Two </label>
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span class="form-control"> <?php echo e($vendor->contact_2); ?></span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-form-label col-md-4 col-sm-3">Email</label>
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span class="form-control"> <?php echo e($vendor->email); ?></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span class="form-control">
                                                <?php echo e(date('d M yy', strtotime($vendor->ac_opening_date))); ?></span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-form-label col-md-4 col-sm-3">Account Note </label>
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span class="form-control"> <?php echo e($vendor->accounts_note); ?></span>
                                        </div>
                                    </div>
                                    <br>
                                    <!-- <div class="form-group row">
                                        ...
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span class="form-control"> <?php echo e($vendor->hosting_company); ?></span>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span class="form-control"> <?php echo e($vendor->username); ?></span>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <?php if($vendor->actor_type==1): ?>
                                            <span class="form-control">Distributor</span>
                                            <?php elseif($vendor->actor_type==2): ?>
                                            <span class="form-control">Enduser</span>
                                            <?php elseif($vendor->actor_type==0): ?>
                            ...
                            <div class="kt-section__body text-dark">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="tab-eg1-0" role="tabpanel">
                                        <input type="hidden" id="vendor_pid" value="<?php echo e($vendor->id); ?>">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <select class="form-control kt-select2-2" name="vendor_type">
                                                    ...
                                                    <option value="<?php echo e($type->id); ?>"
                                                        <?php echo e(($vendor->vendor_type==$type->id) ? 'selected':''); ?>>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <input type="text" class="form-control" name="vendor_id"
                                                    value="<?php echo e($vendor->vendor_id); ?>">
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <select class="form-control kt-select2-2" name="employee">
                                                    ...
                                                    <option value="<?php echo e($user->id); ?>"
                                                        <?php echo e(( $user->id == $vendor->employee_id) ? 'selected' : ''); ?>>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <input type="text" class="form-control" name="vendor_name"
                                                    value="<?php echo e($vendor->vendor_name); ?>">
                                        ...
                                        <!-- <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <input type="text" class="form-control" name="father_name"
                                                    value="<?php echo e($vendor->father_name); ?>">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <input type="text" class="form-control" name="mother_name"
                                                    value="<?php echo e($vendor->mother_name); ?>">
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <div class="input-group date">
                                                    <input type="text" name="date_of_birth"
                                                        ...
                                                        value="<?php echo e($vendor->date_of_birth); ?>" />
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                ...
                                                <select class="form-control kt-select2-2" id="division" name="division">
                                                    ...
                                                    <option value="<?php echo e($div->id); ?>"
                                                        <?php echo e(( $div->id == $vendor->division) ? 'selected' : ''); ?>>
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <select class="form-control kt-select2-2 districtList" id="district"
                                                    ...
                                                    <option value="<?php echo e($dis->id); ?>"
                                                        <?php echo e(( $dis->id == $vendor->district) ? 'selected' : ''); ?>>
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <select class="form-control kt-select2-2 thanaList" id="thana"
                                                    ...
                                                    <option value="<?php echo e($tha->id); ?>"
                                                        <?php echo e(( $tha->id == $vendor->thana) ? 'selected' : ''); ?>>
                                                        <?php echo e($tha->name); ?>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <input type="text" class="form-control" name="nid_no"
                                                    value="<?php echo e($vendor->nid_no); ?>">
                                        ...
                                        <!-- <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <select class="form-control kt-select2-2" name="gender">
                                                    ...
                                                    <option value="1" <?php echo e(($vendor->gender==1) ? 'selected' : ''); ?>>Male
                                                    </option>
                                                    <option value="2" <?php echo e(($vendor->gender==2) ? 'selected' : ''); ?>>Female
                                                    </option>
                                                </select>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <textarea class="form-control" name="present_address"
                                                    rows="3"><?php echo e($vendor->present_address); ?></textarea>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <textarea class="form-control" name="permanent_address"
                                                    rows="3"><?php echo e($vendor->permanent_address); ?></textarea>
                                        ...
                                        <!-- <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <textarea class="form-control" name="billing_address"
                                                    rows="3"><?php echo e($vendor->billing_address); ?></textarea>
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="contact_one"
                                                        value="<?php echo e($vendor->contact_1); ?>">
                                                    <div class="input-group-append"><span class="input-group-text"><i
                                                                class="fas fa-phone"></i></span></div>
                                                </div>
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="contact_two"
                                                        value="<?php echo e($vendor->contact_2); ?>">
                                                    <div class="input-group-append"><span class="input-group-text"><i
                                                                class="fas fa-phone"></i></span></div>
                                                </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <textarea class="form-control" name="company_address"
                                                    rows="3"><?php echo e($vendor->address); ?></textarea>
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="latitude"
                                                        value="<?php echo e($vendor->latitude); ?>">
                                                    <div class="input-group-append"><span class="input-group-text"><i
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="longitude"
                                                        value="<?php echo e($vendor->longitude); ?>">
                                                    <div class="input-group-append"><span class="input-group-text"><i
                                                                class="fab fa-google"></i></span></div>
                                                </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <textarea class="form-control" name="short_note"
                                                    rows="3"><?php echo e($vendor->short_note); ?></textarea>
                                        ...
                                        <div class="col-lg-7 col-md-8 col-sm-12">
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="skype_id"
                                                    value="<?php echo e($vendor->skype_id); ?>">
                                                <div class="input-group-append"><span class="input-group-text"><i
                                        ...
                                        <div class="col-lg-7 col-md-8 col-sm-12">
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="facebook_url"
                                                    value="<?php echo e($vendor->facebook); ?>">
                                                <div class="input-group-append"><span class="input-group-text"><i
                                        ...
                                        <div class="col-lg-7 col-md-8 col-sm-12">
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="twitter_url"
                                                    value="<?php echo e($vendor->twitter); ?>">
                                                <div class="input-group-append"><span class="input-group-text"><i
                                        ...
                                        <div class="col-lg-7 col-md-8 col-sm-12">
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="linkedin_url"
                                                    value="<?php echo e($vendor->linkedin); ?>">
                                                <div class="input-group-append"><span class="input-group-text"><i
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <input type="text" class="form-control" name="platform_username"
                                                    value="<?php echo e($vendor->hosting_company); ?>">
                                        ...
                                        <!-- <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <select class="form-control kt-select2-2" name="package_type">
                                                    <option value="1" <?php echo e(($vendor->package_type==1) ? 'selected' : ''); ?>>
                                                        Prepaid</option>
                                                    <option value="2" <?php echo e(($vendor->package_type==2) ? 'selected' : ''); ?>>
                                                        Postpaid</option>
                                                </select>
                                        ...
                                        <!-- <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <input type="text" class="form-control" name="vendor_due_limit"
                                                    value="<?php echo e($vendor->vendor_due_limit); ?>">
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <div class="input-group date">
                                                    <input type="text" name="ac_opening_date"
                                                        class="form-control datepicker"
                                                        value="<?php echo e($vendor->ac_opening_date); ?>" />
                                                    <div class="input-group-append">
                                                        <span class="input-group-text">
                                                            <i class="la la-calendar"></i>
                                                        </span>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <select class="form-control kt-select2-2" name="reporter">
                                                    ...
                                                    <?php echo e(generate_simple_dropdown('users', 'name', '', $vendor->reporter)); ?>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <select class="form-control kt-select2-2" name="follower">
                                                    <option value="0">Select</option>
                                                    <?php echo e(generate_simple_dropdown('users', 'name', '', $vendor->follower)); ?>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <textarea class="form-control" name="accounts_note"
                                                    rows="3"><?php echo e($vendor->accounts_note); ?></textarea>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <select class="form-control kt-select2-2 kt-select2-2"
                                                    name="global_status">
                                                    <option value="0" <?php echo e(($vendor->global_status==0) ? 'selected' : ''); ?>>
                                                        Inactive</option>
                                                    <option value="1" <?php echo e(($vendor->global_status==1) ? 'selected' : ''); ?>>
                                                        Active</option>
                                                    <option value="2" <?php echo e(($vendor->global_status==2) ? 'selected' : ''); ?>>
                                                        Overdue</option>
                                                    <option value="3" <?php echo e(($vendor->global_status==3) ? 'selected' : ''); ?>>
                                                        On
                                                        Hold</option>
                                                    <option value="4" <?php echo e(($vendor->global_status==4) ? 'selected' : ''); ?>>
                                                        Stop
                                                    </option>
                                                </select>
                                        ...
                                        <!-- <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <select class="form-control kt-select2-2" name="role">
                                                    <option value="1" <?php echo e(($vendor->actor_type==1) ? 'selected' : ''); ?>>
                                                        Distributor</option>
                                                    <option value="2" <?php echo e(($vendor->actor_type==2) ? 'selected' : ''); ?>>
                                                        Enduser
                                                    </option>
                                                    <option value="0" <?php echo e(($vendor->actor_type==0) ? 'selected' : ''); ?>>
                                                        Only
                                                        Viewer</option>
                                                </select>
...
</script><?php /**PATH /var/www/html/resources/views/enduser/dashboard/vendor_view.blade.php ENDPATH**/ ?>